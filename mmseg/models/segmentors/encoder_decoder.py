...
class EncoderDecoder(BaseSegmentor):
    ...
    def forward_train(self, img, img_metas, gt_semantic_seg):
        ...
        # print("torch.unique(gt_semantic_seg)", torch.unique(gt_semantic_seg))
        # tensor([  0,   1,   2,   3,   4,   5, 255], device='cuda:0') dict(type='LoadAnnotations', reduce_zero_label=True),
        # tensor([  0,   1,   2,   3,   4,   5,   6, 255], device='cuda:0') dict(type='LoadAnnotations'),
