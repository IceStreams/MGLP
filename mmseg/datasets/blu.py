...
class BLUDataset(CustomDataset):
    """LoveDA dataset.
    ...
    """
    CLASSES = ('Background/Barren', 'Built-up', 'Vegetation', 'Water', 'Agricultural ', 'Road')

    PALETTE = [[255, 255, 255], [255, 0, 0], [0, 255, 0], [0, 0, 255], [255, 255, 0], [125, 125, 125]]

    def __init__(self, **kwargs):
        super(BLUDataset, self).__init__(
            img_suffix='.png',
            seg_map_suffix='.png',
